...
init-hdfs: start-hdfs
	...
	${hadoop.root}/bin/hdfs dfs -mkdir /user/${hdfs.user.name}/${hdfs.k}

# Load data to HDFS
upload-input-hdfs: start-hdfs
	${hadoop.root}/bin/hdfs dfs -put ${hdfs.input}/* /user/${hdfs.user.name}/${hdfs.input}
	${hadoop.root}/bin/hdfs dfs -put ${hdfs.k}/* /user/${hdfs.user.name}/${hdfs.k}
...
upload-input-aws: make-bucket
	...
	aws s3 sync ${aws.k} s3://${aws.bucket.name}/${aws.k}
